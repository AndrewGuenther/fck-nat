...
al2022-ami-arm64: package-rpm
	packer build -var 'version=$(VERSION)' -var-file="packer/fck-nat-arm64.pkrvars.hcl" -var-file="packer/fck-nat-al2022.pkrvars.hcl" $(regions_file) packer/fck-nat.pkr.hcl

al2022-ami-x86: package-rpm
	packer build -var 'version=$(VERSION)' -var-file="packer/fck-nat-x86_64.pkrvars.hcl" -var-file="packer/fck-nat-al2022.pkrvars.hcl" $(regions_file) packer/fck-nat.pkr.hcl

al2-ami: al2-ami-arm64 al2-ami-x86

al2022-ami: al2022-ami-arm64 al2022-ami-x86

all-amis: al2-ami al2022-ami
